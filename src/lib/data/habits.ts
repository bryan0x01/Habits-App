 ...
 * `minimum: true` marks the basics used for the lightweight daily view.
 */
export const DEFAULT_HABITS: Habit[] = [
  ...
  { id: "habit-money", name: "Money check-in", emoji: "money", cadence: "weekly", category: "money", tinyStart: "Open your balance and look at the latest activity." },
];
